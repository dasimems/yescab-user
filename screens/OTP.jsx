...
const OTP = () => {
  ...
  return (
    <ScreenContainer
      style={{ flex: 1, padding: 20, backgroundColor: whiteColor.default }}
    >
      <View style={{ flex: 1 }}>
        <View
          style={{
        ...
        >
          <RegistrationHeader
            title="Verification"
            subTitle="Kindly enter the OTP sent to your mobile phone "
          />
      ...
      <RegistrationFooter next={NavNames.Register.name} />
    </ScreenContainer>
  );
};
